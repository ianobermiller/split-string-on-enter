...
const SplitStringOnEnter = {
  ...
  splitString(event: {abortKeyBinding: () => void}): void {
  ...
  getConnector(scopes: Array<string>): string {
  ...
  getScopesAtPos(pos: atom$Point): Array<string> {
    return this.editor.scopeDescriptorForBufferPosition(pos).getScopesArray();
  },

  getStringTypeAtPosition(pos: atom$Point): 'single'|'double'|null {
